...
EnDirMotorDriver::EnDirMotorDriver(uint8_t torque_pwm_pin, uint8_t dir_pin)
...
EnDirMotorDriver::~EnDirMotorDriver()
{
    disable_output();
...
void EnDirMotorDriver::set_duty_cycle(uint8_t duty_cycle_percentage)
{
    // Clamp output.
...
void EnDirMotorDriver::set_pwm_frequency(uint32_t freq_hz)
{
